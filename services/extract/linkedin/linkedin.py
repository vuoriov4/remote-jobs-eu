import sys 
sys.path.insert(0, './py-linkedin-jobs-scraper-master/linkedin_jobs_scraper')
...
#import importlib  
#LinkedinScraper = importlib.import_module(
#  "py-linkedin-jobs-scraper-master/linkedin_jobs_scraper/linkedin_scraper",
#  package='linkedin'
#)
...
def extract_linkedin_jobs(on_data, query, locations, limit):
  queries = [
    Query(
      query=query, # Remote
  ...
  # Add event listeners
  scraper.on(Events.DATA, lambda eventdata: on_data(eventdata._asdict()))
